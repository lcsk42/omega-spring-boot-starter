...
public final class ServletUtil {
    ...
    public static Map<String, String> getParamMap(ServletRequest request) {
        return getParams(request).entrySet().stream().collect(
    ...
    public static Map<String, String> getHeaderMap(HttpServletRequest request) {
        return Collections.list(request.getHeaderNames()).stream()
                .collect(Collectors.toMap(Function.identity(),
                        request::getHeader, (existing, replacement) -> existing, HashMap::new));
    }
    ...
    public static Map<String, Cookie> getCookieMap(HttpServletRequest httpServletRequest) {
        ...
        if (ArrayUtils.isEmpty(cookies)) {
            ...
            return Stream.of(cookies).collect(
                    Collectors.toMap(Cookie::getName, Function.identity(),
