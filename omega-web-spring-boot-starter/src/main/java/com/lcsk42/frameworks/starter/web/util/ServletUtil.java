...
public final class ServletUtil {
  ...
  public static Map<String, String> getParamMap(ServletRequest request) {
    return getParams(request).entrySet().stream().collect(Collectors.toMap(Map.Entry::getKey,
  ...
  public static boolean isMultipart(HttpServletRequest request) {
    if (!isPost(request)) {
      ...
      return StringUtils.isNoneBlank(contentType)
          && StringUtils.startsWithIgnoreCase("multipart/", contentType);
    }
  }
  ...
  public static Map<String, Cookie> getCookieMap(HttpServletRequest httpServletRequest) {
    ...
    if (ArrayUtils.isEmpty(cookies)) {
      ...
      return Stream.of(cookies).collect(Collectors.toMap(Cookie::getName, Function.identity(),
  ...
  public static void write(HttpServletResponse response, InputStream inputStream, String fileName,
    ...
    response.setHeader(HttpHeaders.CONTENT_DISPOSITION,
        ContentDisposition.attachment().filename(fileName, charset).build().toString());
   ...
   * @param contentType 文件的 MIME 类型
   */
  public static void writeToInline(HttpServletResponse response, InputStream inputStream,
   ...
   */
  public static void writeToInline(HttpServletResponse response, InputStream inputStream,
      String fileName, String contentType, Charset charset) {
    response.setHeader(HttpHeaders.CONTENT_DISPOSITION,
        ContentDisposition.inline().filename(fileName, charset).build().toString());
    response.setCharacterEncoding(charset.toString());
    response.setContentType(contentType);
    write(response, inputStream);
  }
