package com.lcsk42.frameworks.starter.idempotent.aop;
...
import com.lcsk42.frameworks.starter.idempotent.handler.IdempotentExecuteHandlerFactory;
...
public class IdempotentAspect {
     ...
     * @return 目标方法的执行结果
     */
    @Around("@annotation(com.lcsk42.frameworks.starter.idempotent.annotation.Idempotent)")
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        Idempotent idempotent = getIdempotent(joinPoint);
        IdempotentExecuteHandler instance =
                IdempotentExecuteHandlerFactory.getInstance(idempotent.scene(), idempotent.type());
        Object resultObj;
        try {
