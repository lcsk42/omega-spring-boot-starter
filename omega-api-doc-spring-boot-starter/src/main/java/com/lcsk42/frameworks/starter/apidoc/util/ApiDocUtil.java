package com.lcsk42.frameworks.starter.apidoc.util;
...
public final class ApiDocUtil {
  ...
  public static String getEnumValueTypeAsString(Class<?> enumClass) {
    ...
    // 定义枚举值类型的映射
    Map<Class<?>, String> typeMap = Map.of(Integer.class, "integer", Long.class, "long",
        Double.class, "number", String.class, "string");
    // 遍历所有接口
  ...
  public static Map<Object, String> getDescMap(Class<?> enumClass) {
    ...
    return Arrays.stream(enums).collect(Collectors.toMap(BaseEnum::getValue,
        BaseEnum::getDescription, (o, n) -> o, LinkedHashMap::new));
  }
}
